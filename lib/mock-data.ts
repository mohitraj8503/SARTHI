...
export const MOCK_USERS = [
  {
    ...
    password: '$2b$10$uBWM./K0rE7Rmgur5LnSQugspg0a2C2yQccf0qvmkPkG4sODWpd2m', // AdminDemo@123
  ...
  },
  {
    ...
    password: '$2b$10$uBWM./K0rE7Rmgur5LnSQugspg0a2C2yQccf0qvmkPkG4sODWpd2m', // AdminDemo@123 / SARTHI2026
    avatar_url: '/sarthi-logo.png',
    role: 'ADMIN',
    status: 'ACTIVE',
    onboarded: true,
  ...
  },
  {
    ...
    password: '$2b$10$NxCs4TdL1cJD.7Mfezy9I.bCut/biFVpRJAiIbzf2Mek8/hD43Zxa', // TrainerDemo@123
    avatar_url: '/images/instructors/mohit-raj-real.jpg',
    role: 'TEACHER',
    status: 'ACTIVE',
    onboarded: true,
    department: 'India Meteorological Department - Capacity Building Division',
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    id: 'user_trainer_sarthi',
  ...
  },
  {
    ...
    password: '$2b$10$rGDmv3ib3tsrNlLWyS4Wmu696PvaPjTVN9gqaeT0ebaoEoBUuX8rq', // StudentDemo@123
    role: 'STUDENT',
    status: 'ACTIVE',
    onboarded: true,
    college: 'India Meteorological Department / Arka Jain University',
    currentCourse: 'Meteorological Computing & Applied AI',
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    password: '$2b$10$YbX5PAWmEYv19gaJqfGiN.3GilnuzpbAB6wvugthwxblGdg4kkZyO', // SARTHI2026
    avatar_url: '/sarthi-logo.png',
    role: 'MENTOR',
    status: 'ACTIVE',
    onboarded: true,
...
export const MOCK_COURSES = [
  ...INITIAL_COURSES.map(c => ({
    ...
    instructor: c.instructor || { name: 'SARTHI Admins', avatar_url: '/sarthi-logo.png' },
    createdAt: new Date(),
    updatedAt: new Date(),
  })),
];
...
export const MOCK_BLOGS = [
  {
    ...
    authorId: 'user_1',
    author: { name: 'SARTHI Admins', avatar_url: '/sarthi-logo.png' },
  ...
  },
  {
    ...
    content: `
      ...
      <p>At SARTHI, we update our curriculum every month to keep up with the pace of AI innovation.</p>
    `,
    category: 'Career',
    status: 'published',
...
export const MOCK_BLOGS = [
  {
    id: 'blog_1',
    title: 'The Future of Full-Stack Architecture in 2026: Micro-frontends & Edge Compute',
    slug: 'future-of-full-stack-architecture-2026',
    excerpt: 'Explore how modern distributed systems, Serverless Edge computing, and Next.js Turbopack are reshaping web development workflows for ultra-low latency applications.',
    content: 'Full-stack development in 2026 has transitioned from monolithic setups to distributed edge architectures...',
    category: 'Tech',
    status: 'published',
    featured: true,
    thumbnail: '/images/courses/fullstack-thumb.png',
    tags: ['FullStack', 'Nextjs', 'Edge', 'Architecture'],
    views: 3420,
    readTime: '6 min',
  ...
  {
    id: 'blog_2',
    title: 'Building Production-Ready AI Agents with TypeScript and LLMs',
    slug: 'building-production-ready-ai-agents',
    excerpt: 'A comprehensive guide to developing robust autonomous workflows, structured output schemas, and resilient retry architectures in modern AI applications.',
    content: 'Autonomous agents require predictable deterministic guardrails combined with probabilistic model outputs...',
    category: 'Tech',
    status: 'published',
    featured: false,
    thumbnail: '/images/courses/python-ai-thumb.png',
    tags: ['AI', 'TypeScript', 'Agents', 'LLM'],
    views: 2890,
    readTime: '8 min',
    publishedAt: new Date('2026-03-05T12:00:00Z'),
    author: {
      name: 'SARTHI Engineering Team',
      avatar_url: '/sarthi-logo.png',
  ...
  {
    id: 'blog_3',
    title: 'Cloud Fundamentals: Best Practices for Scalable Multi-Cloud Infrastructures',
    slug: 'cloud-fundamentals-scalable-infrastructure',
    excerpt: 'Deep dive into microservice orchestrations, resilient caching layers with Redis, and zero-downtime database migration strategies.',
    content: 'Modern cloud infrastructure is built on zero-trust security and elasticity...',
    category: 'Tech News',
    status: 'published',
    featured: false,
    thumbnail: '/images/courses/cloud-thumb.png',
    tags: ['Cloud', 'DevOps', 'Docker', 'Redis'],
    views: 1950,
    readTime: '5 min',
    publishedAt: new Date('2026-03-08T14:30:00Z'),
    author: {
      name: 'SARTHI Cloud Architects',
      avatar_url: '/sarthi-logo.png',
      image: '/sarthi-logo.png',
    }
  },
  {
    id: 'blog_4',
    title: 'How SARTHI Empowers 10,000+ Students with Real-World Industry Projects',
    slug: 'sarthi-empowering-students-industry-projects',
    excerpt: 'Discover how hands-on capstone projects, automated code assessments, and dedicated mentorship fast-track developer careers across India.',
    content: 'Traditional learning curricula often lag behind rapidly evolving industry needs...',
    category: 'Success Stories',
    status: 'published',
    featured: false,
    thumbnail: '/images/courses/excel-thumb.png',
    tags: ['Internships', 'Careers', 'Mentorship', 'Growth'],
    views: 4120,
    readTime: '4 min',
      ...
      for (const relationKey of Object.keys(args.include)) {
        if (args.include[relationKey]) {
          if (relationKey === '_count') {
            result._count = {
              lessons: MOCK_LESSONS.filter(l => l.courseId === item.id).length || 14,
              enrollments: MOCK_ENROLLMENTS.filter(e => e.courseId === item.id).length || item.studentsEnrolled || 950
            };
          }
          if (relationKey === 'modules') {
            const courseMods = MOCK_MODULES.filter(m => m.courseId === item.id);
            result.modules = courseMods.length > 0 ? courseMods.map(m => ({
              ...m,
              lessons: MOCK_LESSONS.filter(l => l.moduleId === m.id)
            })) : (item.curriculum || []);
          }
          if (relationKey === 'lessons') {
            result.lessons = MOCK_LESSONS.filter(l => (l.moduleId === item.id || l.courseId === item.id) && l.isPublished);
          }
          if (relationKey === 'instructor') {
            result.instructor = item.instructor || MOCK_USERS.find(u => u.id === item.instructorId) || { name: 'Expert Mentor', image: '/images/instructors/mohit-raj-real.jpg' };
          }
          if (relationKey === 'user') {
